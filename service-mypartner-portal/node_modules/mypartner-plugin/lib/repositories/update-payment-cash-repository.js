...
class UpdatePaymentCashRepository extends base_request_repository_1.BaseRequestRepository {
    constructor() {
        super(...arguments);
        this.registerMethod = () => {
            this.server.method({
        ...
        this.updatePaymentCash = (request) => {
        ...
        this._queryPaymentCash = (request, profileQueryOptions) => {
...
exports.UpdatePaymentCashRepository = UpdatePaymentCashRepository;
//# sourceMappingURL=update-payment-cash-repository.js.map