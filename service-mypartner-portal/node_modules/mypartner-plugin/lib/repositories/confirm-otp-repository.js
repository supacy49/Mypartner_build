...
class ConfirmOtpRepository extends base_request_repository_1.BaseRequestRepository {
    constructor() {
        super(...arguments);
        this.registerMethod = () => {
            this.server.method({
        ...
        this._queryConfirmOtp = (request, profileQueryOptions) => {
...
exports.ConfirmOtpRepository = ConfirmOtpRepository;
//# sourceMappingURL=confirm-otp-repository.js.map