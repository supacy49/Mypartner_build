...
class ArsOrderRepository extends base_request_repository_1.BaseRequestRepository {
    constructor() {
        super(...arguments);
        this.registerMethod = () => {
            this.server.method({
        ...
        this.arslocation = (request, param) => {
            ...
            let responsePromise = new Promise(function (resolve, reject) {
                db.model('arslocation').find({}).exec().then((res) => {
                    let obj = {
                        "body": {
                            "resultCode": "S",
        ...
        this.exportArs = (request) => __awaiter(this, void 0, void 0, function* () {
            let params = request.payload;
            console.log('params => ', params);
            var $this = this;
            const loggerName = 'ars-order';
            let reqOptions = this._getReqOptionsPost(request);
            let blob = yield this.exportExcel(params);
            let responsePromise = yield new Promise(function (resolve, reject) {
                let obj = {
                    "body": {
                        resultCode: "20000",
                        resultMessage: "Success",
    ...
    exportExcel(data) {
        ...
        return workbook.xlsx.writeBuffer().then((res) => {
            console.log('res => ', res);
            return res;
        });
    }
...
exports.ArsOrderRepository = ArsOrderRepository;
//# sourceMappingURL=ars-order.js.map